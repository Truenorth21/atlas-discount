...
create table public.quote_adjustments (
  ...
  hub_routing text,
  case_margin_percent numeric(8, 2),
  pallet_margin_percent numeric(8, 2),
...
create table public.pricing_settings (
  ...
  case_margin_percent numeric(8, 2) not null default 25,
  pallet_margin_percent numeric(8, 2) not null default 18,
